...
const map = new Map([
    ...
    ["book30", require("../../assets/images/book30.jpeg")],

    ["book31", require("../../assets/images/book31.jpeg")],
    ["book32", require("../../assets/images/book32.jpg")],
    ["book34", require("../../assets/images/book34.jpg")],
...
export class HomeViewModel {
    ...
    cardViewModels: CardViewModel[] = [
        ...
        new CardViewModel("book30", `Have you yourself forgotten that you’re an angel walking amongst man?`),
        new CardViewModel("book32", "The last time I light up a marbolo red was five years, six months, seven hours, three minutes and fifteen seconds ago. It smelled like you."),
        new CardViewModel("book31", "back2"),
        ...
        new CardViewModel("book34", "back2"),
